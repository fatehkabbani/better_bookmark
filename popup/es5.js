...
!(function (t) {
    ...
    function s(t) {
        ...
        return /^#([A-Fa-f0-9]{3}){1,2}$/.test(t)
            ? (3 === (i = t.substring(1).split("")).length && (i = [i[0], i[0], i[1], i[1], i[2], i[2]]), { r: ((i = "0x" + i.join("")) >> 16) & 255, g: (i >> 8) & 255, b: 255 & i })
            : { r: 0, g: 0, b: 0 };
    }
    var e = (function () {
            function t(i, e, h) {
                ...
                _cc(t, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this.o.c.w / 2,
                                i = this.o.c.h / 2;
                            return { x: Math.random() * t, y: Math.random() * i, halfHeight: i, halfWidth: t };
                        },
                    },
                    {
                        key: "gnfr",
                    ...
                    },
                    {
                        ...
                        value: function (t, s, e) {
                            this.o.size.pulse && ((this.s += this.o.size.pulse * this.d), (this.s > this.o.size.max || this.s < this.o.size.min) && (this.d *= -1), (this.s = Math.abs(this.s))),
                                ...
                                t.beginPath(),
                                this.o.blending && "none" !== this.o.blending && (t.globalCompositeOperation = this.o.blending);
                            var h = this.gr(this.r, this.o.opacity.center),
                                a = this.gr(this.r, this.o.opacity.edge),
                                n = "c" === this.h ? this.s / 2 : "t" === this.h ? 0.577 * this.s : "s" === this.h ? 0.707 * this.s : this.s,
                ...
                _cc(h, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.o.c = { w: t.clientWidth, h: t.clientHeight }), (this.c.width = this.o.c.w), (this.c.height = this.o.c.h);
